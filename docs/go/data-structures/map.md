...
**map** — это "ссылочный" тип данных, предназначенный для хранения пар ключ-значение. В других языках эту структуру так же называют: хэш-таблица, словарь, ассоциативный массив. Запись, чтение и удаление элементов происходят в основном за O(1).
