...
2. **Понимание последствий**:
	Паника приводит к завершению программы, поэтому важно понимать последствия её вызова. Если можно восстановиться после ошибки, лучше использовать механизм обработки ошибок через интерфейс [error](errors.md)
