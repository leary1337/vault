...
**Go** — это простой и производительный язык программирования от Google с открытым исходным кодом, идеально подходящий для создания веб-сервисов и клиент-серверных приложений.
