...
В Go можно писать конкурентные программы, которые могут быть параллельными, если это поддерживается оборудованием. Конкурентность управляется [Go runtime](../runtime/runtime-overview.md), который эффективно планирует горутины на доступных ядрах процессора.
...
**Конкурентность** — это мощный инструмент для улучшения производительности и эффективности программ, особенно в многозадачных средах. В Go конкурентность реализуется с помощью *горутин и каналов*, что делает многопоточную разработку более простой и безопасной.
