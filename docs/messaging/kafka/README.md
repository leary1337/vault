...
Старая монолитная заметка сохранена как [legacy source material](legacy-overview.md), исключена из публичной навигации и не является актуальной документацией.
