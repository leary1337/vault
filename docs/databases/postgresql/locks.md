...
Ноль изменённых строк означает конфликт; клиент перечитывает данные или сообщает пользователю. Это не универсальная замена isolation: инварианты между несколькими строками требуют другого механизма.
