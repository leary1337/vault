...
**User Datagram Protocol (UDP)** — это протокол транспортного уровня в стеке [TCP/IP](../fundamentals/tcp-ip-model.md), предназначенный для передачи дейтаграмм — коротких сообщений, также называемых пакетами.
...
### Краткое содержание
**UDP (User Datagram Protocol)** — это транспортный протокол, обеспечивающий передачу дейтаграмм (коротких сообщений) без установки соединения. UDP не гарантирует надежность или сохранение порядка сообщений, но обладает преимуществом высокой скорости передачи.
